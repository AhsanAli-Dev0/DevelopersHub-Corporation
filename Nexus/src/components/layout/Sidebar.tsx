...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    {
    to:'/calendar',  icon: <Calendar size={18} />, text:'Calendar',
    },
    {
    to:'/video-call',  icon: <Video size={18} />, text:'Video Call',
    },
    {
    to:'/document-chamber',  icon: <File size={18} />, text:'Document Chamber',
    },
    {
    to:'/payment',  icon: <CircleDollarSign size={18} />, text:'Payment',
    },
    {
    to:'/security',  icon: <Lock size={18} />, text:'Security',
    }
  ];

...
import VideoCallHub from './components/videocall/videoCall';
import DocumentChamber from './components/documentChamber/documentchamber';
import PaymentHub from './components/payment/payment';
import SecurityHub from './components/security/security';
      ...
      <Router>
        <Routes>
          ...
          <Route path="/video-call" element={<DashboardLayout />}>
            <Route index element={<VideoCallHub />} />
          </Route>
          ...
          <Route path="/payment" element={<DashboardLayout />}>
            <Route index element={<PaymentHub />} />
          </Route>
